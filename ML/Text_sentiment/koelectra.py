...
def Text_sentiment_inferense(cursor,artice_code):
    ...
    model = ElectraForSequenceClassification.from_pretrained("monologg/koelectra-small-v3-discriminator",num_labels = 2).to(device)
    print("경로 : ",BASE_DIR)
    ...
    for idx in range(5):
        ...
        inferense_loader = DataLoader(inferense_dataset, batch_size=16, shuffle=False)
