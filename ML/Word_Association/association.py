...
def Text_association_inferense(cursor, artice_code):
    ...
    for idx in tqdm(range(3)):
        ...
        for ind in range(10):
            G_centrality.add_edge(result_df_1['word1'][ind], result_df_1['word2'][ind], weight=int(result_df_1['freq'][ind]))
        ...
        for ind in range(10):
            G.add_weighted_edges_from([(result_df_1['word1'][ind], result_df_1['word2'][ind], int(result_df_1['freq'][ind]))])
